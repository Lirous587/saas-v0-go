...
func (o *Role) GetRoleButtons() RoleButtonSlice {
	if o == nil {
		return nil
	}
...
func (r *roleR) GetRoleButtons() RoleButtonSlice {
	if r == nil {
		return nil
	}
...
func (o *Role) GetRoleMenus() RoleMenuSlice {
	if o == nil {
		return nil
	}
...
func (r *roleR) GetRoleMenus() RoleMenuSlice {
	if r == nil {
		return nil
	}
...
func (o *Role) GetTenantUserRoles() TenantUserRoleSlice {
	if o == nil {
		return nil
	}
...
func (r *roleR) GetTenantUserRoles() TenantUserRoleSlice {
	if r == nil {
		return nil
	}
...
func (q roleQuery) OneG() (*Role, error) {
...
func (q roleQuery) AllG() (RoleSlice, error) {
...
func (q roleQuery) CountG() (int64, error) {
...
func (q roleQuery) ExistsG() (bool, error) {
...
func (o *Role) RoleButtons(mods ...qm.QueryMod) roleButtonQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"role_button\".\"role_id\"=?", o.ID),
	)
...
func (o *Role) RoleMenus(mods ...qm.QueryMod) roleMenuQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"role_menu\".\"role_id\"=?", o.ID),
	)
...
func (o *Role) TenantUserRoles(mods ...qm.QueryMod) tenantUserRoleQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"tenant_user_role\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadTenant(e boil.Executor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
...
func (roleL) LoadRoleButtons(e boil.Executor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		qm.From(`role_button`),
		qm.WhereIn(`role_button.role_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (roleL) LoadRoleMenus(e boil.Executor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		qm.From(`role_menu`),
		qm.WhereIn(`role_menu.role_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (roleL) LoadTenantUserRoles(e boil.Executor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`tenant_user_role.role_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Uses the global database handle.
func (o *Role) AddRoleButtonsG(insert bool, related ...*RoleButton) error {
...
// Appends related to o.R.RoleButtons.
// Sets related.R.Role appropriately.
func (o *Role) AddRoleButtons(exec boil.Executor, insert bool, related ...*RoleButton) error {
	var err error
...
// Sets related.R.Role appropriately.
// Uses the global database handle.
func (o *Role) AddRoleMenusG(insert bool, related ...*RoleMenu) error {
...
// Appends related to o.R.RoleMenus.
// Sets related.R.Role appropriately.
func (o *Role) AddRoleMenus(exec boil.Executor, insert bool, related ...*RoleMenu) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.RoleID = o.ID
...
// Sets related.R.Role appropriately.
// Uses the global database handle.
func (o *Role) AddTenantUserRolesG(insert bool, related ...*TenantUserRole) error {
...
// Appends related to o.R.TenantUserRoles.
// Sets related.R.Role appropriately.
func (o *Role) AddTenantUserRoles(exec boil.Executor, insert bool, related ...*TenantUserRole) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.RoleID = o.ID
...
func FindRoleG(iD int64, selectCols ...string) (*Role, error) {
	return FindRole(boil.GetDB(), iD, selectCols...)
}

// FindRole retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindRole(exec boil.Executor, iD int64, selectCols ...string) (*Role, error) {
	roleObj := &Role{}
...
func (o *Role) InsertG(columns boil.Columns) error {
...
func (o *Role) UpdateG(columns boil.Columns) (int64, error) {
...
func (q roleQuery) UpdateAllG(cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o RoleSlice) UpdateAllG(cols M) (int64, error) {
...
func (o *Role) UpsertG(updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
...
func (o *Role) DeleteG() (int64, error) {
...
func (q roleQuery) DeleteAllG() (int64, error) {
...
func (o RoleSlice) DeleteAllG() (int64, error) {
...
func (o *Role) ReloadG() error {
	if o == nil {
		return errors.New("orm: no Role provided for reload")
	}
...
func (o *RoleSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("orm: empty RoleSlice provided for reload all")
	}
...
func RoleExistsG(iD int64) (bool, error) {
	return RoleExists(boil.GetDB(), iD)
}

// RoleExists checks if the Role row exists.
func RoleExists(exec boil.Executor, iD int64) (bool, error) {
	var exists bool
