...
var CommentLikeTableColumns = struct {
	...
	TenantID:  "comment_likes.tenant_id",
...
var CommentLikeWhere = struct {
	...
	TenantID:  whereHelperstring{field: "\"comment_likes\".\"tenant_id\""},
	CommentID: whereHelperstring{field: "\"comment_likes\".\"comment_id\""},
	UserID:    whereHelperstring{field: "\"comment_likes\".\"user_id\""},
...
func (o *CommentLike) GetTenant() *Tenant {
	if o == nil {
		return nil
	}
...
func (r *commentLikeR) GetTenant() *Tenant {
	if r == nil {
		return nil
	}
...
var (
	commentLikeAllColumns            = []string{"tenant_id", "comment_id", "user_id", "created_at"}
	commentLikeColumnsWithoutDefault = []string{"tenant_id", "comment_id", "user_id"}
	commentLikeColumnsWithDefault    = []string{"created_at"}
	commentLikePrimaryKeyColumns     = []string{"tenant_id", "user_id", "comment_id"}
...
func (o *CommentLike) Tenant(mods ...qm.QueryMod) tenantQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (commentLikeL) LoadTenant(e boil.Executor, singular bool, maybeCommentLike interface{}, mods queries.Applicator) error {
	var slice []*CommentLike
	var object *CommentLike
...
func (o *CommentLike) SetComment(exec boil.Executor, insert bool, related *Comment) error {
	...
	values := []interface{}{related.ID, o.TenantID, o.UserID, o.CommentID}
...
// SetTenantG of the commentLike to the related item.
// Sets o.R.Tenant to related.
// Adds o to related.R.CommentLikes.
// Uses the global database handle.
func (o *CommentLike) SetTenantG(insert bool, related *Tenant) error {
	return o.SetTenant(boil.GetDB(), insert, related)
}

// SetTenant of the commentLike to the related item.
// Sets o.R.Tenant to related.
// Adds o to related.R.CommentLikes.
func (o *CommentLike) SetTenant(exec boil.Executor, insert bool, related *Tenant) error {
	var err error
	if insert {
		if err = related.Insert(exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
...
func FindCommentLikeG(tenantID string, userID string, commentID string, selectCols ...string) (*CommentLike, error) {
	return FindCommentLike(boil.GetDB(), tenantID, userID, commentID, selectCols...)
}

// FindCommentLike retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindCommentLike(exec boil.Executor, tenantID string, userID string, commentID string, selectCols ...string) (*CommentLike, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"comment_likes\" where \"tenant_id\"=$1 AND \"user_id\"=$2 AND \"comment_id\"=$3", sel,
	)

	q := queries.Raw(query, tenantID, userID, commentID)
...
func (o *CommentLike) Delete(exec boil.Executor) (int64, error) {
	...
	sql := "DELETE FROM \"comment_likes\" WHERE \"tenant_id\"=$1 AND \"user_id\"=$2 AND \"comment_id\"=$3"
...
func (o *CommentLike) Reload(exec boil.Executor) error {
	ret, err := FindCommentLike(exec, o.TenantID, o.UserID, o.CommentID)
	if err != nil {
		return err
	}
...
func CommentLikeExistsG(tenantID string, userID string, commentID string) (bool, error) {
	return CommentLikeExists(boil.GetDB(), tenantID, userID, commentID)
}

// CommentLikeExists checks if the CommentLike row exists.
func CommentLikeExists(exec boil.Executor, tenantID string, userID string, commentID string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"comment_likes\" where \"tenant_id\"=$1 AND \"user_id\"=$2 AND \"comment_id\"=$3 limit 1)"

	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, sql)
		fmt.Fprintln(boil.DebugWriter, tenantID, userID, commentID)
	}
	row := exec.QueryRow(sql, tenantID, userID, commentID)
...
func (o *CommentLike) Exists(exec boil.Executor) (bool, error) {
	return CommentLikeExists(exec, o.TenantID, o.UserID, o.CommentID)
}
